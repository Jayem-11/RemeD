                          ...
                          < form onSubmit={formik.handleSubmit} >
                              <Stack spacing={4}>
                                  {currentStep === 1 && (
                                      <>
                                          ...
                                          />
                                          {formik.errors.firstname && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.firstname}</Text>}
                                          <Input
                                          ...
                                          />
                                          {formik.errors.lastname && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.lastname}</Text>}
                                          ...
                                          />
                                          {formik.errors.password && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.password}</Text>}
                                  ...
                                  {currentStep === 2 && (
                                      <>
                                          ...
                                          />
                                          {formik.errors.institution && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.institution}</Text>}
                                          ...
                                          />
                                          {formik.errors.speciality && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.speciality}</Text>}
                                          ...
                                          />
                                          {formik.errors.address && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.address}</Text>}
                                          ...
                                          />
                                          {formik.errors.phoneno && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.phoneno}</Text>}
                                          ...
                                          />
                                          {formik.errors.license && <Text fontSize={"xs"} color={"red.400"}>{formik.errors.license}</Text>}
                              ...
                              <HStack spacing={4}>
                                  ...
                                  <Button
                                      ...
                                      onClick={() => currentStep === 2 ? formik.handleSubmit : setCurrentStep(2)}
                                  >
